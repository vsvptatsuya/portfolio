...
<!-- end of twitter follow badge -->
	...
	<div id="left">
			<div id="contents">
				<div id="about">
					<a href="index.html"><img src="images/thankyou_off.png" alt="thankyou" width="680" height="400" /> </a>
					<br />
					<h1>Thank you</h1>
					     
						<?php echo "<br>送信しました。<br>ご登録ありがとうございました．<br><br>";?>
		...
		<div id="right">
	            ...
	            <div id="twitter">
	                ...
	                }).render().setUser('KaworiM0531').start();
	                </script>
			  	</div> <!--twitter end-->
            <div id="banner">
