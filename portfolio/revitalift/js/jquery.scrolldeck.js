			...
			for (i=0; i<$('.animate-in').length; i++) {
				...
				switch (anim.attr('data-animation')) {
					case 'fly-in-left':
						...
						scrolldeck.controller.animate(anim, { delay: windowHeight/10, duration: windowHeight/2, property:'left', start:-1000 });
						/*
					...
					case 'fly-in-right':
						...
						break;
					case 'space-in':
						scrolldeck.controller.animate(anim, { delay: windowHeight*0.5, duration: windowHeight*0.2, property:'letter-spacing', start:40 });
						scrolldeck.controller.animate(anim, { delay: windowHeight*0.5, duration: windowHeight*0.2, property:'opacity', start:0 });
						break;
					case 'space-in2':
						scrolldeck.controller.animate(anim, { delay: windowHeight*0.6, duration: windowHeight*0.2, property:'letter-spacing', start:40 });
						scrolldeck.controller.animate(anim, { delay: windowHeight*0.6, duration: windowHeight*0.2, property:'opacity', start:0 });
						break;
					case 'space-in3':
						...
						break;
					case 'space-in4':
						scrolldeck.controller.animate(anim, { delay: windowHeight*0.85, duration: windowHeight*0.2, property:'letter-spacing', start:40 });
						scrolldeck.controller.animate(anim, { delay: windowHeight*0.85, duration: windowHeight*0.2, property:'opacity', start:0 });
						break;
					case 'space-in5':
						scrolldeck.controller.animate(anim, { delay: windowHeight*1.2, duration: windowHeight*0.2, property:'letter-spacing', start:40 });
						scrolldeck.controller.animate(anim, { delay: windowHeight*1.2, duration: windowHeight*0.2, property:'opacity', start:0 });
						break;
					case 'fade-in0':
						scrolldeck.controller.animate(anim, { delay: windowHeight/600, duration: windowHeight/8, property:'opacity', start:0 });
						break;
					case 'fade-in':
						scrolldeck.controller.animate(anim, { delay: windowHeight/3, duration: windowHeight/2, property:'opacity', start:0 });
						break;
					case 'fade-in2':
						scrolldeck.controller.animate(anim, { delay: windowHeight/2.4, duration: windowHeight/2, property:'opacity', start:0 });
						break;
					case 'fade-in3':
						scrolldeck.controller.animate(anim, { delay: windowHeight/2, duration: windowHeight/2, property:'opacity', start:0 });
						break;
					case 'fade-in4':
						scrolldeck.controller.animate(anim, { delay: windowHeight/1.4, duration: windowHeight/2, property:'opacity', start:0 });
						break;
					case 'fade-in5':
						scrolldeck.controller.animate(anim, { delay: windowHeight/0.8, duration: windowHeight/2, property:'opacity', start:0 });
						break;
					default:
						scrolldeck.controller.animate(anim, { delay: windowHeight/2, duration: windowHeight/2, property:'opacity', start:0 });
				}
