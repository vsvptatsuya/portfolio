...
// 設定
$mail_to = 'endor.com@gmail.com'; // フォームデータを受け取るメールアドレス
$mail_subject = 'Endor.comフォームメール送信'; // 受け取る時のSubject（件名）
$reply_subject = 'Endor.comフォームメールより自動返信です'; // 送信者へ自動返信のSubject（件名）
